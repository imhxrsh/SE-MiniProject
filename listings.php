...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center my-5">
            <h5 class="d-flex justify-content-center align-items-center col-lg-7 text-center" style="margin: 0;">Hotel Listings</h5>
        ...
        <div class="d-flex container flex-column justify-content-center align-items-center">
            <?php
            $select_hotels = mysqli_query($conn, "SELECT * FROM `hotels` WHERE `status` = TRUE ORDER BY `rating` DESC") or die('query failed');
